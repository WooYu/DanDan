...
public class Constant extends EaseConstant {
	public static final String WX_APPID = "wx2b822156da8e9756";
    public static final String WX_APPSECRET = "267319f48918695359d2803eeaecb158";
	...
	public static final String HEAD_IMAGE_URL = "headImageUrl";//鍙戦�佷汉鐨勫ご鍍�
	public static final String USER_ID = "userid";
//	public static final String USER_NAME = "username";
	public static final String USER_NAME = "Nickname";
	public static final String USER_VIP = "djvip";
	public static final String SEX = "sex";
	public static final String OBJECT_HEAD_IMAGE_URL = "objectHeadImageUrl";//鎺ユ敹浜虹殑澶村�?
